# from tellcore.telldus import TelldusCore, QueuedCallbackDispatcher


# dispatcher = QueuedCallbackDispatcher()
# telldus = TelldusCore(callback_dispatcher=dispatcher)
# # telldus = TelldusCore()
# devices = {device.id: device for device in telldus.devices()}

# for device_id, device in devices.iteritems():
#     print '> id=%s, name=%s, type=%s' % (str(device_id), device.name, device.type)


# # Listener
# def raw_event(data, controller_id, cid):
#     print data, controller_id, cid


# # Raw receiver
# def raw_receiver():
#     # Listen for codes
#     telldus.callback_dispatcher.process_pending_callbacks()

# telldus.register_raw_device_event(raw_event)
